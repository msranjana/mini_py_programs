...
def next_colour():
    ...
    if timeleft > 0:
        ...
        label.config(fg=colours[1], text=colours[0])  # Update the text and its color
...
def countdown():
    ...
    if timeleft > 0:
        ...
        scoreshow()  # Show scores when time runs out
...
def scoreshow():
    ...
    button = tk.Button(window2, text="Close", command=window2.destroy)
    button.pack(pady=10)
...
#window.iconbitmap("color_game_icon.ico")  # Ensure you have this icon in the same directory
